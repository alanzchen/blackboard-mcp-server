 ...
 */
export const ContentReviewMethods: { [key: string]: ApiMethodInfo } = {
  getReviewStatus: {
 ...
 */
export const ContentReviewHandlers = {
  getReviewStatus: async (accessToken: string, args: Record<string, unknown>) => {
    const methodInfo = ContentReviewMethods.getReviewStatus;
  ...
  updateReviewStatus: async (accessToken: string, args: Record<string, unknown>) => {
    const methodInfo = ContentReviewMethods.updateReviewStatus;
