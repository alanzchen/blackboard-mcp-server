 ...
 */
export const CourseMessagesMethods: { [key: string]: ApiMethodInfo } = {
  getMessages: {
    ...
    requestType: "CourseMessagesGetMessagesRequest",
    isMultipart: false,
    originalName: "getMessages",
    isWrite: false
  } as ApiMethodInfo,
  ...
  createMessage: {
    ...
    "properties": {
        ...
        "attachment": {
            ...
            "$ref": "#/definitions/blackboard.webapps.blackboard.publicapi.v1.message.CourseMessageAttachment"
        },
        "toUsers": {
    ...
    responseSchema: {
    "type": "reference",
    "ref": "blackboard.platform.restspring.http.RestResponseEntity<blackboard.webapps.blackboard.publicapi.v1.message.CourseMessageV1>",
    "typeName": "BlackboardPlatformRestspringHttpRestResponseEntityblackboardWebappsBlackboardPublicapiV1MessageCourseMessageV1"
},
    requestType: "CourseMessagesCreateMessageRequest",
    isMultipart: false,
  ...
  getFolders: {
    ...
    requestType: "CourseMessagesGetFoldersRequest",
    isMultipart: false,
    originalName: "getFolders",
    isWrite: false
  } as ApiMethodInfo,
  ...
  deleteMessage: {
    ...
    requestBodySchema: null,
    responseSchema: null,
    requestType: "CourseMessagesDeleteMessageRequest",
    isMultipart: false,
  ...
  updateMessage: {
    ...
    responseSchema: {
    "type": "reference",
    "ref": "blackboard.webapps.blackboard.publicapi.v1.message.CourseMessage",
    "typeName": "BlackboardWebappsBlackboardPublicapiV1MessageCourseMessage"
},
    requestType: "CourseMessagesUpdateMessageRequest",
    isMultipart: false,
  ...
  getMessageParticipants: {
    ...
    requestType: "CourseMessagesGetMessageParticipantsRequest",
    isMultipart: false,
    originalName: "getMessageParticipants",
    isWrite: false
  } as ApiMethodInfo
};
 ...
 */
export const CourseMessagesHandlers = {
  getMessages: async (accessToken: string, args: Record<string, unknown>) => {
    const methodInfo = CourseMessagesMethods.getMessages;
  ...
  createMessage: async (accessToken: string, args: Record<string, unknown>) => {
    const methodInfo = CourseMessagesMethods.createMessage;
  ...
  getFolders: async (accessToken: string, args: Record<string, unknown>) => {
    const methodInfo = CourseMessagesMethods.getFolders;
  ...
  deleteMessage: async (accessToken: string, args: Record<string, unknown>) => {
    const methodInfo = CourseMessagesMethods.deleteMessage;
  ...
  updateMessage: async (accessToken: string, args: Record<string, unknown>) => {
    const methodInfo = CourseMessagesMethods.updateMessage;
  ...
  getMessageParticipants: async (accessToken: string, args: Record<string, unknown>) => {
    const methodInfo = CourseMessagesMethods.getMessageParticipants;
