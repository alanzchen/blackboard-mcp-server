 ...
 */
export const CourseTocMethods: { [key: string]: ApiMethodInfo } = {
  getTocItems: {
 ...
 */
export const CourseTocHandlers = {
  getTocItems: async (accessToken: string, args: Record<string, unknown>) => {
    const methodInfo = CourseTocMethods.getTocItems;
  ...
  updateTocItem: async (accessToken: string, args: Record<string, unknown>) => {
    const methodInfo = CourseTocMethods.updateTocItem;
